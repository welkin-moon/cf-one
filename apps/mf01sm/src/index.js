...
const QUESTIONS = [
  ...
  { id: 'aut1', key: 'autonomy', pair: 'aut', text: '关系中的重要边界和决定，我通常希望自己保留明确的决定权。' },
  ...
  { id: 'aut2', key: 'autonomy', text: '即使很信任对方，我也倾向于自己参与决定会显著影响我的事情。' },
  ...
  { id: 'aut3', key: 'autonomy', text: '当一件事主要影响我本人时，我更舒服于自己掌握最终决定，而不是完全交给对方。' },
  ...
  { id: 'aut4', key: 'autonomy', pair: 'aut', text: '亲密关系越重要，我越希望双方协商，而不是让一方长期替另一方做决定。' }
];
