...
try {
  ...
  const requiredMarkers = [
    '4.0.5','mf01sm-v4-independent-leaf','mixed-v4-stable-reuse',
    ...
    'scores too large','self stats too large','mf01sm-v4-self-stats-1','mf01sm-v4-history-2','mf01sm-v4-answers-1',
    'KV Legacy/Fallback','cis-male-blue','cis-female-pink','safe-area-inset-left','sameSexAttraction',
    '里百合 / 药娘预备役 / 软糯伪娘','爹系狂攻 / 强制爱暴君 / 掌控狂'
  ];
  ...
  const message = 'mf01sm v4.0.5 responsive result layout and identity-aware LGBTQIA+ background';
  const metadata = {
